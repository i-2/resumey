...
const EMPLOYMENT_FIELDS = [
    ...
    { name: "start", title: "Start Date", placeholder: "Enter the start date", "type": "date", "validate": Yup.date().required(), default: new Date()},
    { name: "end", title: "End Date", placeholder: "Enter the end date", "type": "date", "validate": Yup.date().required(), default: new Date() },
